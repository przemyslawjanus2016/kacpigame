...
android {
    ...
    signingConfigs {
        if (!releaseStoreFile.isNullOrBlank() && !releaseStorePassword.isNullOrBlank() && !releaseKeyAlias.isNullOrBlank() && !releaseKeyPassword.isNullOrBlank()) {
            create("githubRelease") { storeFile = File(releaseStoreFile); storePassword = releaseStorePassword; keyAlias = releaseKeyAlias; keyPassword = releaseKeyPassword }
        }
    }
    ...
    buildTypes {
        ...
        release {
            ...
            if (signingConfigs.findByName("githubRelease") != null) signingConfig = signingConfigs.getByName("githubRelease")
        }
    }
