...
object AttractionContent {
    ...
    fun all(): List<AttractionInfo> = cards.values.sortedBy { it.stageId }
            ...
            "w2s10",
            "Kopiec Krakusa to jeden z najstarszych krakowskich kopców. Ze szczytu rozciąga się szeroki widok na miasto.",
            "Krakus Mound is one of Krakow's oldest mounds and offers a wide view across the city.",
            "Kopiec tradycyjnie łączony jest z legendarnym księciem Krakiem, od którego imienia ma pochodzić nazwa Krakowa.",
            "The mound is traditionally linked with the legendary Prince Krak, whose name is associated with Krakow.",
            "Krakus Mound Krakow panorama"
        ),
        ...
        searchItem(
            "w4s10",
            "Rzym łączy zabytki starożytne, średniowieczne uliczki, renesansowe pałace i barokowe place. Warstwy historii są tu widoczne niemal na każdym kroku.",
            "Rome combines ancient monuments, medieval streets, Renaissance palaces and Baroque squares. Layers of history are visible almost everywhere.",
            "Rzym często nazywa się Wiecznym Miastem — określenie to ma przypominać o jego niezwykle długiej historii i znaczeniu.",
            "Rome is often called the Eternal City, a nickname that reflects its exceptionally long history and importance.",
            "Rome skyline panorama Colosseum Vatican"
        ),
        ...
        searchItem(
            "w5s10",
            "Londyn rozwijał się nad Tamizą przez wiele stuleci. Obok historycznych budynków powstały tu nowoczesne wieżowce, muzea i dzielnice pełne życia.",
            "London has developed along the Thames for many centuries. Historic buildings now stand beside modern towers, museums and lively neighbourhoods.",
            "W granicach Wielkiego Londynu mieszka kilka milionów osób, a w mieście używa się setek języków.",
            "Several million people live in Greater London, and hundreds of languages are spoken across the city.",
            "London skyline Thames panorama"
        ),
        ...
        searchItem(
            "w6s10",
            "Mediolan łączy sztukę, architekturę, modę, sport i nowoczesny design. W jednym mieście można zobaczyć gotycką katedrę i futurystyczne wieżowce.",
            "Milan combines art, architecture, fashion, sport and modern design. In one city you can see a Gothic cathedral and futuristic towers.",
            "Mediolan jest stolicą Lombardii i jednym z największych centrów gospodarczych Włoch.",
            "Milan is the capital of Lombardy and one of Italy's largest economic centres.",
            "Milan skyline Duomo modern panorama"
        ),
        ...
        searchItem(
            "w7s10",
            "Maltański archipelag leży w środkowej części Morza Śródziemnego. Na małej powierzchni można tu znaleźć ufortyfikowane miasta, prehistoryczne świątynie i skaliste wybrzeża.",
            "The Maltese archipelago lies in the central Mediterranean. In a small area it combines fortified cities, prehistoric temples and rocky coasts.",
            "Na Malcie obowiązują dwa języki urzędowe: maltański i angielski.",
            "Malta has two official languages: Maltese and English.",
            "Malta archipelago panorama Valletta Gozo Comino"
        )
    ).associateBy { it.stageId }
    ...
    fun all(): List<AttractionInfo> = cards.values.sortedBy { it.stageId }
            ...
            "w3s10",
            "Dolina Pięciu Stawów Polskich to wysokogórska dolina znana z jezior i surowego tatrzańskiego krajobrazu.",
            "The Valley of Five Polish Ponds is a high-mountain valley known for its lakes and dramatic Tatra scenery.",
            "W dolinie znajduje się najwyżej położone schronisko turystyczne w polskiej części Tatr.",
            "The valley contains the highest mountain hut in the Polish Tatras.",
            "Dolina Pieciu Stawow Polskich Tatry"
        ),
